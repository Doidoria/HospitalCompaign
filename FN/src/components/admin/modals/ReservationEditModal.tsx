      ...
      >
        ...
        >
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-5 custom-scrollbar">
            ...
            {/* 1. 병원 및 일정 */}
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-white p-5 rounded-[20px] border border-slate-100 shadow-sm">
              <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 bg-white p-5 rounded-[20px] border border-slate-100 shadow-sm">
