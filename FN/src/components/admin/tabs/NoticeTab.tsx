...
export default function NoticeTab() {
  ...
  useEffect(() => { fetchNotices(noticePage); }, [fetchNotices, noticePage]);
          ...
          <table className="w-full text-left border-collapse min-w-[700px]">
            ...
            <tbody className="text-sm bg-white">
              {loading ? (
                ...
                // notices 대신 filteredNotices 렌더링
                ...
                <tr><td colSpan={4} className="p-16 text-center text-slate-400">조건에 맞는 공지사항이 없습니다.</td></tr>
              )}
            </tbody>
          </table>
        </div>
