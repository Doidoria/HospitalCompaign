...
function FailContent() {
  ...
  return (
    <div className="bg-white p-8 sm:p-10 rounded-[32px] shadow-sm border border-gray-100 text-center max-w-md w-full mx-4">
      ...
      <h2 className="text-2xl font-extrabold text-gray-800 mb-3">추가 요금 결제 실패</h2>
      ...
      >
        <ArrowLeft className="w-5 h-5" /> 마이페이지로 돌아가기
      </button>
    </div>
  );
}

export default function ExtraPaymentFailPage() {
  return (
