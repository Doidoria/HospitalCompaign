...
import { Receipt, Clock, AlertCircle, ChevronDown, CheckCircle2 } from 'lucide-react';
import Link from 'next/link';

// [최적화 1] 컴포넌트 렌더링 시마다 재할당되지 않도록 정적 데이터는 외부로 분리
const FAQS = [
  {
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans text-gray-900 pb-24">
      ...
      >
        ...
        <motion.div variants={ITEM_VARIANTS} className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          {/* 기본 요금 카드 */}
        ...
        {/* 2. 결제 및 주의사항 */}
        <motion.div variants={ITEM_VARIANTS} className="bg-blue-50 rounded-2xl p-5 flex gap-4 items-start mb-16 border border-blue-100 text-sm">
              ...
              return (
                <div key={index} className="border-b border-gray-100 last:border-0">
                  <button 
                    ...
                    aria-expanded={isOpen} // [최적화 2] 스크린 리더 접근성(A11y) 강화
